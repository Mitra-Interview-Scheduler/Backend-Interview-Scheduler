...
CREATE INDEX idx_candidate_domains_candidate_id ON candidate_domains(candidate_id);
CREATE INDEX idx_candidate_domains_domain_id ON candidate_domains(domain_id);
